...
public class ErrorEndEventTest {
  ...
  @Test
  @Deployment(resources = {"org/camunda/bpm/engine/test/bpmn/event/error/ErrorEventTest.testPropagateOutputVariablesWhileCatchErrorOnCallActivityConcurrentExecution.bpmn20.xml",
  "org/camunda/bpm/engine/test/bpmn/event/error/ErrorEventTest.errorParent.bpmn20.xml"})
  public void testPropagateOutputVariablesWhileCatchErrorOnCallActivityConcurrentExecution() {
    checkOutput();
  }
